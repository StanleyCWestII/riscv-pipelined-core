...
.PHONY: all asm clean vga top all3 cache wave ctest ctest-data cdisasm isa FORCE
all: sim
	./sim
...
clean:
	...
	rm -f sim sim_vga sim_top sim_cache sim_wave sim_c wave.vcd $(HEX) $(BENCH_HEX) vga/vgatest.hex $(C_ELF) $(C_HEX) $(C_DATA_BIN) $(C_DATA_HEX) $(C_DATA_STAMP)
